...
const STR = {
  uk: {
    ...
    sync_now: 'в такт',
    sync_now_hint: 'Натисни рівно в момент, коли зазвучить показаний рядок — текст вирівняється.',
    finish_song: 'Завершити пісню (зарахувати бали)',
    ...
    role_title: 'Як використати цей пристрій?',
    role_screen: 'Екран (TV / ПК)',
    role_screen_desc: 'Відео, текст пісні та рахунок для всієї кімнати',
    role_player: 'Я співаю (телефон)',
    role_player_desc: 'Профіль, свої пісні й мікрофон для співу',
    role_switch: 'Змінити роль',
    kicked_msg: 'Хазяїн вечірки прибрав тебе з кімнати.',
    sing_now: 'Твоя черга — співай!',
    sing_along: 'Співай у свій телефон!',
    sing_mic_btn: 'Увімкнути мікрофон',
    sing_mic_note: 'Звук нікуди не надсилається — рахунок рахується прямо в телефоні.',
    sing_mic_denied: 'Мікрофон не ввімкнувся. Перевір дозволи браузера.',
    sing_mic_stop: 'Вимкнути мікрофон',
    screen_join: 'Скануй і приєднуйся',
    screen_waiting: 'Чекаємо, поки хазяїн увімкне пісню…',
    live_scores: 'Живий рахунок',
  ...
  cs: {
    ...
    sync_now: 'do taktu',
    sync_now_hint: 'Klepni přesně ve chvíli, kdy zazní zobrazený řádek — text se srovná.',
    finish_song: 'Ukončit písničku (započítat body)',
    ...
    role_title: 'K čemu bude tohle zařízení?',
    role_screen: 'Obrazovka (TV / PC)',
    role_screen_desc: 'Video, text písničky a skóre pro celou místnost',
    role_player: 'Zpívám (telefon)',
    role_player_desc: 'Profil, vlastní písničky a mikrofon na zpívání',
    role_switch: 'Změnit roli',
    kicked_msg: 'Pořadatel tě z místnosti odebral.',
    sing_now: 'Jsi na řadě — zpívej!',
    sing_along: 'Zpívej do svého telefonu!',
    sing_mic_btn: 'Zapnout mikrofon',
    sing_mic_note: 'Zvuk se nikam neposílá — skóre se počítá přímo v telefonu.',
    sing_mic_denied: 'Mikrofon se nezapnul. Zkontroluj oprávnění prohlížeče.',
    sing_mic_stop: 'Vypnout mikrofon',
    screen_join: 'Naskenuj a připoj se',
    screen_waiting: 'Čekáme, až pořadatel pustí písničku…',
    live_scores: 'Živé skóre',
